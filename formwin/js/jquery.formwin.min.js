...
function(){return!1};b(a).each(function(){this.onselectstart=this.ondragstart=c;b(this).mousedown(c).css({MozUserSelect:"none"})})};b.formwin.init=function(a){a=b.extend({},b.formwin.defaults,a);if(b.browser.msie){if(8>b.browser.version)return!1;9>b.browser.version&&(f=!0)}b("div.formwinbutton").each(function(){var c=this;!0===b("input, button",this).is(":disabled")?b(c).addClass(a.disabledClass):b(c).removeClass(a.disabledClass);b("input, button",this).focus(function(){b(c).addClass(a.focusClass)}).blur(function(){b(c).removeClass(a.focusClass);
