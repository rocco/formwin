(function(a){a.formwin={defaults:{formWinClassSel:"",formWinSelector:"select, textarea, input[type=text], input[type=checkbox], input[type=radio], input[type=button]",activeClass:"active",focusClass:"focus",hoverClass:"hover",disabledClass:"disabled",checkedClass:"checked",placeholderColor:"gray",selectWidthAdapt:27}};var f=!1,h=!1,i={select:function(b,c){var e=a("div.selectedvalue",b.parent()),d=function(){e.html((b.find(":selected:first")||b.find("option:first")).html());b.parent().removeClass(c.activeClass)};
e.width(b.width()-c.selectWidthAdapt);b.width("100%");d();g(b,{change:d});var f=function(){return!1};a(e).each(function(){this.onselectstart=this.ondragstart=f;a(this).mousedown(f).css({MozUserSelect:"none"})});return b},textarea:function(){!1===h&&(a('<img src="../img/formwin-input-active.png">'),a('<img src="../img/formwin-input-disabled.png">'),a('<img src="../img/formwin-input-focus.png">'),a('<img src="../img/formwin-input-hover.png">'),a('<img src="../img/formwin-input-negative-focus.png">'),
a('<img src="../img/formwin-input-negative-hover.png">'),a('<img src="../img/formwin-input-negative.png">'),a('<img src="../img/formwin-input-normal.png">'),a('<img src="../img/formwin-input-positive-focus.png">'),a('<img src="../img/formwin-input-positive-hover.png">'),a('<img src="../img/formwin-input-positive.png">'),h=!0)},checkbox:function(a,c){var e=a.parent(),d=function(){!0===a.is(":checked")?e.addClass(c.checkedClass):e.removeClass(c.checkedClass)};d();g(a,{"click touchend":d})},radio:function(b,
c){var e=b.parent(),d=function(){!0===b.is(":checked")&&(a("input[name="+b.attr("name")+"]:radio").each(function(){a(this).parent().removeClass(c.checkedClass)}),e.addClass(c.checkedClass))};d();g(b,{"click touchend":function(){d()}})}},g=function(a,c){for(var e in c)c.hasOwnProperty(e)&&a.bind(e,c[e])},j=function(b,c){var e=a(b).attr("placeholder");"undefined"!==typeof e&&""!==e&&(e===a(b).val()&&a(b).val(""),""===a(b).val()&&a(b).val(e).css("color",c.placeholderColor).addClass("formwin-showplaceholder"))};
...
a(this).css("color")),j(this,b);a(this).focus(function(){a(d).addClass(b.focusClass);!0===f&&("undefined"!==typeof a(this).attr("placeholder")&&a(this).hasClass("formwin-showplaceholder"))&&a(this).val("").css("color",a(this).data("formwinOriginalColor"))}).blur(function(){a(d).removeClass(b.focusClass);a(d).removeClass(b.activeClass);!0===f&&"undefined"!==typeof a(this).attr("placeholder")&&(""===a(this).val()?j(this,b):a(this).removeClass("formwin-showplaceholder"))}).on("mouseenter",function(){a(d).addClass(b.hoverClass)}).on("mouseleave",
function(){a(d).removeClass(b.hoverClass);a(d).removeClass(b.activeClass)}).on("keydown mousedown touchbegin",function(){a(d).addClass(b.activeClass)}).on("keyup mouseup touchend",function(){a(d).removeClass(b.activeClass)});!0===a(this).is(":disabled")?a(d).addClass(b.disabledClass):a(d).removeClass(b.disabledClass);e="input"===c?a(this).attr("type").toLowerCase():c;if("undefined"!==typeof i[e])i[e](a(this),b)})})};a.formwin.fixlabels=function(b){b=a.extend({},a.formwin.defaults,b);a("label"+b.formWinClassSel+
".above, label"+b.formWinClassSel+".below").each(function(){var b=a("span",this),e=b.css("white-space"),d=0;b.css("white-space","nowrap");d=b.width();b.css("white-space",e);d>a("textarea, input, select",this).width()&&b.parent().css("width",d+"px")});a("label"+b.formWinClassSel+".left, label"+b.formWinClassSel+".right").each(function(){var b=a("span",this).css("white-space","nowrap"),e=b.width(),d="right";a(this).hasClass("left")&&(d="left");a(this).css("margin-"+d,e+10+"px");b.css(d,-1*(e+10)+"px")})}})(jQuery);
